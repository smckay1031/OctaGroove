...
export default function Card({prop}) {
    ...
    return(
        <div key={prop.id} className="p-5 flex flex-col items-center justify-center border-2 border-[#ffffff40] rounded-xl max-w-64 bg-[#18d862] text-black font-Inter">
            <h4 className="text-3xl font-black py-5 w-full">{prop.header}</h4>
