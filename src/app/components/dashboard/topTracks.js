...
// This function coverts ms to a string of min:sec for duration diplay
    ...
    return(
        <div className=" flex flex-col h-72 p-1 font-Inter bg-[#80808005] rounded-lg shadow-md shadow-black backdrop-blur border-[#ffffff27] border" id="topTracks">
            <h2 className="text-2xl font-bold text-center pt-1"> Top Tracks</h2>
            ...
            <ul className="p-1 overflow-y-scroll">
                {tracks.items.map((item) =>(
                    <div className="pl-4">
                        <li key={item.id} className="list-decimal list-outisde my-1 py-0.5 text-xs leading-none font-light  bg-[#ffffff0b] rounded-md shadow-md shadow-black backdrop-blur border-[#ffffff27] border-0.5">
