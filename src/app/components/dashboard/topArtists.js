...
async function GetTopArtist(range) {
    ...
    return (
        <div className=" h-72 font-Inter bg-[#80808005] pl-6 pr-4 pt-2 pb-5 rounded-md shadow-md shadow-black backdrop-blur border-[#ffffff27] border flex flex-col items-center justify-center">
        <h2 className="text-xl font-bold py-2"> Top Artists</h2>
