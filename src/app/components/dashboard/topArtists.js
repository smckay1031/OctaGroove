...
async function GetTopArtist(range) {
    ...
    if(response.ok) {
        ...
        return (
            <div className=" h-72 font-Inter bg-[#00000040] pl-6 pt-2 pb-5 rounded-3xl shadow-md shadow-black backdrop-blur border-[#ffffff27] border flex flex-col items-center justify-center" id="topArtists">
