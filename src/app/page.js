    ...
    <main className="relative">
      ...
      <article className="flex flex-col items-center justify-center py-64 lg:px-64 px-10 " >
        ...
        <div className="flex flex-wrap items-center justify-center w-full">
          <p className=" w-1/2 flex-grow pt-20 px-5"> <span className="font-bold text-lg">OctaGroove</span> is an online dashboard designed to be used with your Spotify app to enhance your listening experience. You will have an <span className="font-bold text-lg">enhanced UI experience</span> that allows you to view your top eight items. <span className="font-bold text-lg">Your data is never stored on our servers and is never shared with anyone.</span> Simply sign in to your Spotify account to get started.<br /> <span className="font-bold text-lg"> Please insure cookies are allowed for this app to work properly.</span></p>
          <Image
          src={ScreenShot}
          alt="dashboard"
          width={350}
